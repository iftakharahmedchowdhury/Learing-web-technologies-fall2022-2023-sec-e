...
function addUser($user)
{
    ...
    $conn = getConnection();
    $sql = "insert into userreg values( '{$user['userName']}', '{$user['password']}', '{$user['confirmpassword']}', '{$user['email']}', '{$user['userType']}')";
...
function loginCheck($user)
{
    ...
    $sql = "SELECT * FROM userreg where userName='{$user['patientUserName']}' AND password='{$user['patientPassword']}'";
...
{
    $conn = getConnection();
    $sql = "select * from userreg where userType='User' ";
